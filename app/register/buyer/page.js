/**
 * Buyer Signup Page
 * Dedicated registration page for buyers
 */
    ...
    <div className="min-h-screen bg-gray-50 font-body flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-4">Create Buyer Account</h1>
          <p className="text-gray-600 mt-2">Start shopping from verified sellers</p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                  placeholder="John"
                  required
                />
              </div>
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-600">
            Want to sell on BizConnect?{' '}
            <Link href="/seller/setup" className="text-primary font-medium hover:underline">
              Become a Seller
            </Link>
          </p>
        </div>
