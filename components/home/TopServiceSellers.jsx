/**
 * Top Service Sellers Component
 * Displays verified sellers offering services
 */
...
export default function TopServiceSellers() {
  ...
  const fetchServiceSellers = async () => {
    try {
      setLoading(true);
      // Fetch sellers with service-related categories
      const response = await fetch('/api/sellers?limit=4&type=service');
      ...
      console.error('Error fetching service sellers:', error);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div>
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-4xl font-bold text-gray-900 font-heading">Top Service Providers</h2>
            </div>
            <p className="text-gray-600 text-lg">Hire expert freelancers for your business needs</p>
          </div>
          <Link href="/verified-sellers?type=service">
        ...
        {loading ? (
              ...
              >
                <Link href={`/seller/${seller._id}`}>
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-gray-600 mb-4">{seller.businessCategory || 'Service Provider'}</p>
          ...
          <div className="text-center py-12">
            <p className="text-gray-500">No service providers found at the moment.</p>
          </div>
        )}
      </div>
    </motion.section>
